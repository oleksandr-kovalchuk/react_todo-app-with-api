...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://<oleksandr-kovalchuk>.github.io/react_todo-app-with-api/) and add it to the PR description.
